...
class classTChartLine extends TTabDefault implements iObject{
    public function labelTitle(){
        $obj = new TLabel(array(
             text=>"Chart Line Demo",
             name=>"label_name",
             padding=>"10 10 10 10",
    ...
    public function TContainerObj(){
		...
		$main->items->add('chartline',$center);
	    return $main;
	}
    
    public function execute(){
	   return $this->TTabObj($this->TContainerObj(),'chartline');
    }
}
?>
