<?php
class classTButtonCycle extends TTabDefault implements iObject{
    public function labelTitle(){
       $obj = new TLabel(array(
    	    text=>"Button Cycle Demo",
            name=>"label_name",
            padding=>"10 10 10 10",
    ...
    public function TContainerObj(){
      ...
      $obj->items->add('buttoncycle',$this->TButtonObj());
	  return $obj;
	}
    
    public function execute(){
       return $this->TTabObj($this->TContainerObj(),'buttoncycle');
    }
}
?>
