...
Defaults to: false</div>
    ...
    <div>
		...
		<br />
      	The new checked state of the checkbox.</div>
    </div>
    <div>
...
Defaults to: ""</div>
    ...
    <div>
        <h3><a href="#">labelAlign : <strong class="stitulo">String</strong></a></h3>
            <div>Controls the position and alignment of the fieldLabel. Valid values are:
			<br /><br />
