...
<div id="accordion">
    ...
    <div>
        ...
        <div class="barra">Multiple date formats separated by "|" to try when parsing a user input value and it doesn't match the defined format.
        <br /><br />
        Defaults to: "g:ia|g:iA|g:i a|g:i A|h:i|g:i|H:i|ga|ha|gA|h a|g a|g A|gi|hi|gia|hia|g|H|gi a|hi a|giA|hiA|gi A|hi A"</div>
    </div>
    <div>
    ...
    <div>
        ...
        <div>True to disable the field. Disabled Fields will not be submitted.
        <br /><br />
    ...
    <div>
        ...
        <div>true to enable the proxying of key events for the HTML input field
        <br /><br />
        Defaults to: false</div>
    </div>
    <div>
    ...
    <div>
        ...
        <div class="barra">The default time format string which can be overriden for localization support. The format must be valid according to Ext.Date.parse (defaults to 'g:i         A', e.g., '3:15 PM'). For 24-hour time format try 'H:i' instead.
        <br /><br />
        Defaults to: "g:i A"</div>
    </div>
    <div>
    ...
    <div>
        <h3><a href="#"> increment: <strong class="stitulo"> Number </strong></a></h3>
        <div class="barra">The number of minutes between each time value in the list.
        <br /><br/>
        Defaults to: 15</div>
    </div>
    <div>
        <h3><a href="#"> invalidText: <strong class="stitulo"> String </strong></a></h3>
        <div class="barra">The error text to display when the time in the field is invalid.
        <br /><br />
        Defaults to: "{0} is not a valid time"</div>
    </div>
    <div>
    ...
    <div>
        ...
        <div class="barra">The error text to display when the entered time is after maxValue.
        <br /><br />
        Defaults to: "The time in this field must be equal to or before {0}"</div>
    </div>
    <div>
        <h3><a href="#"> maxValue: <strong class="stitulo"> Date/String </strong></a></h3>
        <div class="barra">The maximum allowed time. Can be either a Javascript date object with a valid time value or a string time in a valid format -- see format and         altFormats.</div>
    </div>
    <div>
    ...
    <div>
        ...
        <div class="barra">The error text to display when the entered time is before minValue.
        <br /><br />
        Defaults to: "The time in this field must be equal to or after {0}"</div>
    </div>
    <div>
        <h3><a href="#"> minValue: <strong class="stitulo"> Date/String </strong></a></h3>
        <div class="barra">The minimum allowed time. Can be either a Javascript date object with a valid time value or a string time in a valid format -- see format and          altFormats.</div>
    </div>
    <div>
    ...
    <div>
    	...
    	&bull; Boolean/String
    	<br />
        &bull; True if the value is valid
        <br />
