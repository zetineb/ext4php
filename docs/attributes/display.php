...
<h2 class="demoHeaders">Display</h2>
<div id="accordion">
	<div>
    ...
    <div>
        ...
        <div class="barra">Specify as true to have the Component inject framing elements within the Component at render time to provide a graphical rounded frame around the        Component content.
		<br /><br />
		...
		<br /><br />
		The extra space taken up by this framing is available from the read only property frameSize.</div>
    </div>
    <div>
