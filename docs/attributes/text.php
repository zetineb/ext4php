...
<div id="accordion">
    ...
    <div>
        <h3><a href="#"> inputType: <strong class="stitulo"> String </strong></a></h3>
        <div class="barra">The type attribute for input fields -- e.g. radio, text, password, file. The extended types supported by HTML5 inputs (url, email, etc.) may also be 	        used, though using them will cause older browsers to fall back to 'text'.
  		<br /><br />
