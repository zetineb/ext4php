...
<div id="accordion">
    ...
    <div>
        <h3><a href="#"> items: <strong class="stitulo"> Ext.form.field.Checkbox[]/Object[] </strong></a></h3>
        <div class="barra">An Array of Checkboxes or Checkbox config objects to arrange in the group.</div>
    </div>
    <div>
