...
<div id="accordion">
    ...
    <div>
        <h3><a href="#"> onBlur </a></h3>
        <div class="barra"> Fires when this field loses input focus.
        <br /><br />
        <b>Parameters</b>
        <br /><br />
    ...
    <div>
        ...
        <div class="barra"> Fires when the field's picker is collapsed.
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; container : Ext.form.field.Picker
        <br /><br />
        This field instance <br />
        &bull; options : Object
        <br /><br />
        The options object passed to Ext.util.Observable.addListener. </div>
    </div>
    ...
    <div>
        ...
        <div class="barra"> Fires when the field's picker is expanded.
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; container : Ext.form.field.Picker
    ...
    <div>
        ...
        <div class="barra"> Fires when a value is selected via the picker.
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; component : Ext.form.field.Picker
        <br /><br />
        This field instance <br />
        &bull; value : Object
        <br /><br />
        The value that was selected. The exact type of this value is dependent on the individual field and picker implementations. <br />
        &bull; options : Object
        <br /><br />
        The options object passed to Ext.util.Observable.addListener. </div>
    </div>
