...
<div id="accordion">
    ...
    <div>
        ...
        <br />
        &diams; The direction of the collapse. One of
        <br /><br />
    ...
    <div>
        <h3><a href="#"> onCheckChange </a></h3>
        <div class="barra"> Fires when a node with a checkbox's checked property changes
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; component : Ext.data.Model
        <br />
        The node who's checked property was changed
        <br /><br />
        &bull; checked : Boolean
        <br />
    ...
    <div>
        <h3><a href="#"> onItemClick </a></h3>
        <div class="barra"> Fires when an item is clicked.
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; component : Ext.view.View
        <br /><br />
        &bull; record : Ext.data.Model
        <br />
        The record that belongs to the item
        <br /><br />
        &bull; item : HTMLElement
        <br />
        The item's element
        <br /><br />
        &bull; index : Number
    ...
    <div>
        <h3><a href="#"> onItemCollapse </a></h3>
        <div class="barra"> Fires when this node is collapsed.
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; node : Ext.data.NodeInterface
        <br />
        The collapsing node
        <br /><br />
        &bull; options : Object
    ...
    <div>
        <h3><a href="#"> onItemDblclick </a></h3>
        <div class="barra"> Fires when an item is double clicked.
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; component : Ext.view.View
    ...
    <div>
        <h3><a href="#"> onItemExpand </a></h3>
        <div class="barra"> Fires when this node is expanded.
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; node : Ext.data.NodeInterface
    ...
    <div>
        <h3><a href="#"> onSelect </a></h3>
        <div class="barra"> Fired after a record is selected
        <br /><br />
        <b>Parameters</b>
        <br /><br />
        &bull; component : Ext.selection.RowModel
        <br /><br />
        &bull; record : Ext.data.Model
        <br />
        The selected record
