...
if($_GET['local']=='docs'){
	...
	$_SESSION['login']='DEMO';
	$_SESSION['senha']="123";
	$_SESSION['codigo']='10851';
	$_SESSION['entidade']='9999';
	$_SESSION['perfil'] = '10371';
	$_SESSION['nome']='DEMO';	
}else{
	require "../../source/application.php";
	$js='<script type="text/javascript" src="js/utils.js"></script>';
	$css='<link rel="stylesheet" type="text/css" href="css/app.css"/>';
}
...
try{
	...
	$app->cls='xbody';
	$app->headers->add('utils',$js);
	$app->headers->add('app-style',$css);	
